...
@endif
        ...
        <a href="{{ url('/tambahbarang') }}" class="add-btn">+ Tambah Barang</a>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $item->stok }}</td>
                    <td>
                        <a href="{{ route('barang.edit', $item->id_barang) }}" class="edit-btn">Edit</a>
                        <form action="{{ route('barang.destroy', $item->id_barang) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="delete-btn" onclick="return confirm('Apakah Anda yakin ingin menghapus item ini?');">Hapus</button>
                        </form>
                    </td>
                </tr>
                @endforeach
